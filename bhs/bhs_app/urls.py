...
urlpatterns = [
    ...
    path('create_new_vehicle/', views.create_new_vehicle, name='create_new_vehicle'),
    path('create_new_repair_order/', views.create_new_repair_order, name='create_new_repair_order'),
